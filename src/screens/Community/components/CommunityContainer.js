...
const CommunityContainer = () => {
  const data = [
    { id: '1', name: "user1", title: "title1", detail: "detail1" },
    { id: '2', name: "user2", title: "title2", detail: "detail2" },
  ...
  const renderItem = ({ item }) => (
    <PostContainer name={item.name} title={item.title} detail={item.detail} />
  );
